    ...
    <div>
      ...
      <table className="table">
        ...
        <tbody>
          {data.map((m2) => {
            return (
              <tr scope="row" key={m2.student.id}>
                <td>{m2.student.name}</td>
                <td>{m2.student.mail}</td>
                <td>{m2.student.age}</td>
                <td>{m2.student.phone}</td>
                <td>{m2.student.grade}</td>
                <td>{m2.student.groupe}</td>
                <td>{m2.student.gender}</td>
                <td>{m2.student.school_year}</td>
                <td>
                        <a href={`/marks/${m2.student.id}`}>
                          <button
                            type="submit"
                            value="Envoyer"
                      ...
                      <td>
                        <button
                          ...
                          onClick={(e) => deleteStudent(e,m2.student.id)}
                        >
                          Delete
                        </button>
                      </td>
