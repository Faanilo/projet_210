    ...
    <div>
      ...
      <table className="table">
        ...
        <tbody>
          {data.map((l1) => {
            return (
              <tr scope="row" key={l1.student.id}>
                <td>{l1.student.name}</td>
                <td>{l1.student.mail}</td>
                <td>{l1.student.age}</td>
                <td>{l1.student.phone}</td>
                <td>{l1.student.grade}</td>
                <td>{l1.student.groupe}</td>
                <td>{l1.student.gender}</td>
                <td>{l1.student.school_year}</td>
                <td>
                        <a href={`/marks/${l1.student.id}`}>
                          <button
                            type="submit"
                            value="Envoyer"
                      ...
                      <td>
                        <button
                          ...
                          onClick={(e) => deleteStudent(e,l1.student.id)}
                        >
                          Delete
                        </button>
                      </td>
